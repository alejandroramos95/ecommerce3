...
router.delete("/:id", validarUsuario, async (req, res) => {
...
router.get("/:id/productos", validarUsuario, async (req, res) => {
...
router.post("/:id/productos/:idPrd", validarUsuario, async (req, res) => {
...
router.delete("/:id/productos/:idPrd", validarUsuario, async (req, res) => {
